...
[GNU GPL](LICENSE)
# Synapta EMR - Dev Deployment

## Repository Structure

| Branch | Content |
|---|---|
| `main` | Architecture and planning documents (draw.io, HTML, xlsx, docx files) |
| `openemr` | Actual OpenEMR application source code |
| `dev` | Active development branch — auto-deploys to Azure VM on every push |
...
- **Target:** Azure VM (`synapta-health-vm`) at `/var/www/html`
- **Method:** SSH into VM → pull latest code from `dev` branch
...
GitHub Actions triggers
       ↓
SSH into Azure VM (4.154.190.17)
       ↓
Pull latest dev code → /var/www/html
       ↓
...
| `GH_TOKEN` | GitHub Personal Access Token for authenticated git pull |

## Azure VM Details

| Property | Value |
|---|---|
| VM Name | synapta-health-vm |
| OS | Ubuntu 22.04 LTS |
| Public IP | 4.154.190.17 |
