...
class NoteStructuringService
{
    ...
    public function structure(
        ...
        try {
            ...
            $drugInteraction = $data['drug_interaction'] ?? null;

            $clinicalSummary = [
                'current_vitals'       => $data['current_vitals']       ?? null,
                'new_vitals'           => $data['new_vitals']           ?? null,
                'past_problem_list'    => $data['past_problem_list']    ?? null,
                'negative_lab_results' => $data['negative_lab_results'] ?? null,
    ...
    private function buildPatientContext(array $ctx): array
    {
        ...
        return [
            ...
            'vitals_history'     => $ctx['vitals_history']     ?? [],
